                ...
                <div className="flex flex-wrap -mx-6">
                    <div className="w-full px-6 sm:w-1/2 xl:w-1/3">
                        <div className="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                            <div className="p-3 bg-RestaurantTabColor bg-opacity-75 rounded-full">
                    ...
                    <div className="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                        <div className="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                            <div className="p-3 bg-totalOrderColor bg-opacity-75 rounded-full">
                    ...
                    <div className="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
                        <div className="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
                            <div className="p-3 bg-hoverColor bg-opacity-75 rounded-full">
                            <svg class="w-8 h-8 text-white" viewBox="0 0 28 28" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="mx-5">
                                ...
                                <div className="text-gray-500">Available Items</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <header className="flex items-center justify-around gap-7 py-4 px-4 border-b border-gray-400">
                <div className="flex gap-7 w-1/2 items-center">
                    <h1
                           ...
                           className={`w-1/2 cursor-pointer rounded-lg py-2 text-center text-2xl font-bold tracking-tight text-slate-900 hover:bg-hoverColor hover:text-white sm:text-3xl ${
                               tab === 'Restaurants'
                                   ? 'bg-RestaurantTabColor text-white mr-8'
                                   : 'bg-orange-200 '
                           }`}
                    >
                        Restaurants
                    ...
                    <h1
                        ...
                        className={`w-1/2 cursor-pointer rounded-lg py-2 text-center text-2xl font-bold tracking-tight text-slate-900 hover:bg-hoverColor hover:text-white sm:text-3xl ${
                            tab === 'Items' ? 'customBackgroundColor' : 'bg-orange-200'
                        }`}
                    >
                        Items
                    </h1>
                ...
                <div className="flex justify-end">
                    <button
                        ...
                        className="rounded-lg bg-customOrange text-white px-4 py-2 font-bold hover:bg-RestaurantTabColor"
                    >
